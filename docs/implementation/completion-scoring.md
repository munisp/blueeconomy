...
| S2: Maritime domain intelligence | 15% | 50% | Real maritime-position validation, strict GeoJSON Polygon/MultiPolygon geofence evaluation, authenticated PostgreSQL incident lifecycle, durable spatial-correlation evidence with exact replay/conflict control, maker-checker analyst assignment, transitions, leased outbox delivery and authentic Apache Kafka broker acknowledgement/consumption exist. No authorised feed, Sedona/PostGIS deployment, escalation/notification integration or analyst acceptance exists. |
